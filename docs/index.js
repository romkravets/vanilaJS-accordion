...
var _accordion = __webpack_require__(331);
...
var accordOne = new _accordion.Accordion(document.querySelector('#simpleAccordion'), accordionSection);
var accordTwo = new _accordion.Accordion(document.querySelector('#contentAccordion'), [{
   title: 'Content 1',
...
var ROOT_CLASS_NAMES = 'accordion';
var TITLE_CLASS_NAME = ROOT_CLASS_NAMES + '__title';
var PANEL_CLASS_NAME = ROOT_CLASS_NAMES + '__panel';
var CONTENT_CLASS_NAME = ROOT_CLASS_NAMES + '__content';
var EXPAND_CLASS_NAME = PANEL_CLASS_NAME + '_expand';

function Accordion(targetElement, accordionSections) {
   var controls = void 0;
   ...
   this.renderPanels = function () {
      ...
      try {
         for (var _iterator = accordionSections[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
